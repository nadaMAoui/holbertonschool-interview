...
/**
 * print_array - print the message and the current subarray
 * @array: array to print
 * @from: index to start printing
 * @to: index to end printing
 *
 * Return: nothing
 */
...
/**
 * recursion_binary - finds a value recursively using binary search
 * @array: array to find
...
/**
 * advanced_binary - finds a value using binary search
 * @array: array to find
 * @size: array length
 * @value: value to find
 *
